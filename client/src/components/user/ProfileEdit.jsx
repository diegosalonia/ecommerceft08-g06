...
import { getUserAdmin } from '../../redux/userReducer/actions';
...
const UserProfileAdmin = (props) => {
    ...
    const handleSubmitPassword = (event)=>{
        ...
        dispatch(changePasswordAction(token, id, newPassword))
    }
    ...
    useEffect(()=>{
        dispatch(getUserAdmin(token, id))
    },[dispatch, token]);
                        ...
                        <Card className={classes.card}>
                            <CardContent>
                                ...
                                <Typography className={classes.info} variant="h6">
                                    <Link to="#" onClick={()=>setChangePassword(true)}>Cambiar contraseña</Link>
                                </Typography>
                            </CardContent>
                        </Card>
    ...
    return userRole === 'admin' ? profile() : '404 NOT FOUND';
}
